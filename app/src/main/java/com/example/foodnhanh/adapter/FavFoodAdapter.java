...
import com.example.foodnhanh.model.FoodFavoriteModel;
...
public class FavFoodAdapter extends RecyclerView.Adapter<FavFoodAdapter.ViewHolder> {
        ...
        private ArrayList<FoodFavoriteModel> coffeeItems;
        private Context context;
        private FavDB favDB;

        public FavFoodAdapter(ArrayList<FoodFavoriteModel> coffeeItems, Context context) {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_fav_item,
                    parent,false);
        ...
        public void onBindViewHolder(@NonNull FavFoodAdapter.ViewHolder holder, int position) {
            final FoodFavoriteModel coffeeItem = coffeeItems.get(position);
            ...
            public ViewHolder(@NonNull View itemView) {
                ...
                favBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FoodFavoriteModel coffeeItem = coffeeItems.get(position);
        ...
        private void readCursorData(FoodFavoriteModel coffeeItem, ViewHolder viewHolder) {
            Cursor cursor = favDB.read_all_data(coffeeItem.getKey_id());
            SQLiteDatabase db = favDB.getReadableDatabase();
            try {
                while (cursor.moveToNext()) {
                    //Error need to system help
        ...
        // like click
        private void likeClick (FoodFavoriteModel coffeeItem, Button favBtn, final TextView textLike) {
