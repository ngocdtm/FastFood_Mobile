package com.example.foodnhanh.database;
...
public class OrderContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.foodnhanh";
    public static final Uri BASE_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    // this should be similar to your table name
    public static final String PATH = "cartDB";
    ...
    public static abstract class OrderEntry implements BaseColumns {
        ...
        public static final String TABLE_NAME = "cartDB";
